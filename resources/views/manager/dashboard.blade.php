...
@section('contentManager')
                ...
                <div id="kt_header" class="header" data-kt-sticky="true" data-kt-sticky-name="header"
                    ...
                    <div class="container-xxl d-flex align-items-stretch justify-content-between">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <!--end::Search-->
                            <!--begin::Message-->
                            <button class="btn btn-icon btn-sm btn-active-bg-accent ms-1 ms-lg-6"
                            ...
                            <div class="ms-1 ms-lg-6">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold w-300px"
                                    ...
                                    <div class="row row-cols-2 g-0">
                                        <a href="../dist/profile/overview.html"
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="ps-0">
                                                                        <a href="#"
                                                                            ...
                                                                            Authors</a>
                                                                        <span class="text-muted fw-bold d-block mt-1">HTML,
                                                                            VueJS, Laravel</span>
                                                                    </td>
                                                                    <td>
                                                                        <div class="d-flex flex-column w-100 me-3">
                                            ...
                                            <div class="card-toolbar">
                                                ...
                                                <div class="menu menu-sub menu-sub-dropdown menu-column w-300px w-lg-350px p-5"
                                                    ...
                                                    <div class="input-group input-group-solid mb-5">
                                                        ...
                                                        <input type="text" class="form-control ps-0" name="search"
                                                            value="" placeholder="Filter reports" />
                                                    </div>
                                                    <!--end::Input-->
                                                    <!--begin::Tabs-->
                                                    <ul
                                                    ...
                                                    <ul class="nav flex-column nav-pills nav-pills-custom">
                                                        ...
                                                        <li class="nav-item mb-3">
                                                            <a class="nav-link w-225px h-70px" data-bs-toggle="pill"
                                                                ...
                                                                <div class="ps-1">
                                                                    <span
                                                                        class="nav-text text-gray-600 fw-bolder fs-6">Building
                                                                        Studio</span>
                                                                    <span class="text-muted fw-bold d-block pt-1">HR
                                                                        Solutions</span>
                                                                </div>
                                                        ...
                                                        <li class="nav-item mb-3">
                                                            <a class="nav-link w-225px h-70px" data-bs-toggle="pill"
                                                                ...
                                                                <div class="ps-1">
                                                                    <span
                                                                        class="nav-text text-gray-600 fw-bolder fs-6">Foxy
                                                                        Solutions</span>
                                                                    <span class="text-muted fw-bold d-block pt-1">HR
                                                                        Solutions</span>
                                                                </div>
                                                        ...
                                                        <li class="nav-item mb-5">
                                                            <a class="nav-link w-225px h-70px" data-bs-toggle="pill"
                                                                ...
                                                                <div class="ps-1">
                                                                    <span
                                                                        class="nav-text text-gray-600 fw-bolder fs-6">MyStreams</span>
                                                                    <span class="text-muted fw-bold d-block pt-1">HR
                                                                        Solutions</span>
                                                                </div>
                                                            </a>
                                    ...
                                    <div class="card card-stretch mb-5 mb-xxl-8">
                                        ...
                                        <div class="card-header align-items-center border-0 mt-5">
                                            <h3 class="card-title align-items-start flex-column">
                                                ...
                                                <span class="text-muted mt-2 fw-bold fs-6">Updates &amp;
                                                    notifications</span>
                                            </h3>
                                            <div class="card-toolbar">
                                                <!--begin::Dropdown-->
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td class="text-end">
                                                                        ...
                                                                        <span
                                                                            class="text-muted fw-bold d-block mt-1 fs-7">Paid</span>
                                                                    </td>
                                                                    <td class="text-end">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="px-0">
                                                                        <a href="#"
                                                                            ...
                                                                            Clarcson</a>
                                                                        <span class="text-muted fw-bold d-block mt-1">Most
                                                                            Successful</span>
                                                                    </td>
                                                                    <td></td>
                                                                    <td class="text-end">
                                                                            ...
                                                                            <span class="d-flex align-items-center me-2">
                                                                                ...
                                                                                <span class="d-flex flex-column">
                                                                                    ...
                                                                                    <span class="fs-7 text-muted">Creating
                                                                                        a clear text structure is just one
                                                                                        SEO</span>
                                                                                </span>
                                                                                <!--end:Info-->
                                                                            </span>
                                                        ...
                                                        <div data-kt-stepper-element="content">
                                                            <div class="w-100">
                                                                ...
                                                                <div class="d-flex flex-column mb-7 fv-row">
                                                                    <!--begin::Label-->
                                                                    <label
                                                                        class="required fs-6 fw-bold form-label mb-2">Card
                                                                        Number</label>
                                                                    <!--end::Label-->
                                                                    <!--begin::Input wrapper-->
                                                                ...
                                                                <div class="d-flex flex-stack">
                                                                    <!--begin::Label-->
                                                                    <div class="me-5">
                                                                        <label class="fs-6 fw-bold form-label">Save Card
                                                                    ...
                                                                    <label
                                                                        ...
                                                                        <span
                                                                            class="form-check-label fw-bold text-muted">Save
                                                                            Card</span>
                                                                    </label>
                                                                    <!--end::Switch-->
                                                                </div>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer d-flex justify-content-end">
                                            ...
                                            <button type="button" id="kt_modal_select_location_button"
                                                class="btn btn-primary" data-bs-dismiss="modal">Apply</button>
                                        </div>
                                        <!--end::Modal footer-->
                                    </div>
                                    <!--end::Modal content-->
                                        ...
                                        <div class="card-body pt-0">
                                            ...
                                            <div class="d-flex flex-wrap align-items-center mb-7">
                                                ...
                                                <div class="d-flex flex-column flex-grow-1 pe-3">
                                                    <a href="#"
                                                        class="text-white fw-bolder text-hover-primary fs-6">Soar, Eco</a>
                                            ...
                                            <div class="d-flex flex-wrap align-items-center mb-7">
                                                ...
                                                <div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 pe-3">
                                                    <a href="#"
                                                        class="text-white fw-bolder text-hover-primary fs-6">Cup &amp;
                                                        Green</a>
                                    ...
                                    <div class="card bg-transparent">
                                        ...
                                        <div class="card-body pt-0">
                                            ...
                                            <div class="d-flex flex-wrap align-items-center mb-7">
                                                ...
                                                <div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 pe-3">
                                                    <a href="#"
                                                        class="text-white fw-bolder text-hover-primary fs-6">Top
                                                        Authors</a>
                                                    <span class="text-white opacity-25 fw-bold fs-7 my-1">Successful
                                                        Fellas</span>
                                                </div>
                                            ...
                                            <div class="d-flex flex-wrap align-items-center mb-7">
                                                ...
                                                <div class="d-flex flex-column flex-grow-1 pe-3">
                                                    <a href="#"
                                                        class="text-white fw-bolder text-hover-primary fs-6">New Users</a>
                                                    <span class="text-white opacity-25 fw-bold fs-7 my-1">HTML, CSS.
                                                        jQuery</span>
                                                </div>
                                                <!--end::Title-->
                                ...
                                <div class="card-body pt-2 px-0">
                                    ...
                                    <div class="d-flex mb-6">
                                        ...
                                        <div class="d-flex flex-column">
                                            <a href="#"
                                                class="fs-6 fw-bolder text-hover-primary text-gray-800 mb-2">How to Create
                                                Your First Project with Start Admin Theme</a>
                                            <div class="fw-bold text-muted">But nothing can prepare you for the real thing
                                            </div>
                                        </div>
                                        <!--end::Content-->
                                    </div>
                                    ...
                                    <div class="d-flex mb-6">
                                        ...
                                        <div class="d-flex flex-column">
                                            <a href="#"
                                                class="fs-6 fw-bolder text-hover-primary text-gray-800 mb-2">Start Admin
                                                Theme Getting Started &amp; Installation</a>
                                            <div class="fw-bold text-muted">Long before you sit down to put digital pen
                                            </div>
                                        </div>
                                        <!--end::Content-->
                                    </div>
                                    ...
                                    <div class="d-flex mb-6">
                                        ...
                                        <div class="d-flex flex-column">
                                            <a href="#"
                                                class="fs-6 fw-bolder text-hover-primary text-gray-800 mb-2">Write your
                                    ...
                                    <div class="d-flex mb-6">
                                        ...
                                        <div class="d-flex flex-column">
                                            <a href="#"
                                                class="fs-6 fw-bolder text-hover-primary text-gray-800 mb-2">Use images to
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        ...
                                        <ul
                                            ...
                                            <li class="menu-item">
                                                <a class="menu-link ps-0 py-2 active"
                                                    href="../dist/index.html">Start</a>
                                            </li>
                                            <li class="menu-item">
                                                <a class="menu-link ps-0 py-2"
                                                    href="../dist/dashboards/extended.html">Extended</a>
                                            </li>
                                            <li class="menu-item">
                                                <a class="menu-link ps-0 py-2"
                                                    href="../dist/dashboards/light.html">Light</a>
                                            </li>
                                            <li class="menu-item">
                                                <a class="menu-link ps-0 py-2"
                                                    href="../dist/dashboards/compact.html">Compact</a>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="col-sm-4">
                                        ...
                                        <ul
                                            ...
                                            <li class="menu-item">
                                                <a class="menu-link ps-0 py-2"
                                                    href="../dist/apps/calendar.html">Calendar</a>
                                            </li>
                                            <li class="menu-item">
                                                <a class="menu-link ps-0 py-2"
                                                    href="../dist/apps/chat/private.html">Private Chat</a>
                                            </li>
                                            <li class="menu-item">
                                                <a class="menu-link ps-0 py-2" href="../dist/apps/chat/group.html">Group
                                                    Chat</a>
                                            </li>
                                            <li class="menu-item">
                                                <a class="menu-link ps-0 py-2"
                                                    href="../dist/apps/chat/drawer.html">Drawer Chat</a>
                                            </li>
                                            <li class="menu-item">
                                                <a class="menu-link ps-0 py-2" href="../dist/apps/inbox.html">Inbox</a>
                                            </li>
                                            <li class="menu-item">
                                                <a class="menu-link ps-0 py-2" href="../dist/apps/shop/shop-1.html">Shop
                                                    1</a>
                                            </li>
                                            <li class="menu-item">
                                                <a class="menu-link ps-0 py-2" href="../dist/apps/shop/shop-2.html">Shop
                                                    2</a>
                                            </li>
                                            <li class="menu-item">
                                                <a class="menu-link ps-0 py-2"
                                                    href="../dist/apps/shop/product.html">Shop Product</a>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="col-sm-4">
                                        ...
                                        <ul
                                            ...
                                            <li class="menu-item">
                                                <a class="menu-link ps-0 py-2"
                                                    href="../dist/general/pricing.html">Pricing</a>
                                            </li>
                                            <li class="menu-item">
                                                <a class="menu-link ps-0 py-2"
                                                    href="../dist/general/invoice.html">Invoice</a>
                                            </li>
                                            <li class="menu-item">
                                                <a class="menu-link ps-0 py-2"
                                                    href="../dist/general/login.html">Login</a>
                                            </li>
                                            <li class="menu-item">
                                                <a class="menu-link ps-0 py-2"
                                                    href="../dist/general/wizard.html">Wizard</a>
                                            </li>
                                            <li class="menu-item">
                                                <a class="menu-link ps-0 py-2"
                                                    href="../dist/general/error.html">Error</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        ...
                                        <ul
                                            ...
                                            <li class="menu-item">
                                                <a class="menu-link ps-0 py-2"
                                                    href="../dist/profile/overview.html">Overview</a>
                                            </li>
                                            <li class="menu-item">
                                                <a class="menu-link ps-0 py-2"
                                                    href="../dist/profile/account.html">Account</a>
                                            </li>
                                            <li class="menu-item">
                                                <a class="menu-link ps-0 py-2"
                                                    href="../dist/profile/settings.html">Settings</a>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="col-sm-4">
                                        ...
                                        <ul
                                            ...
                                            <li class="menu-item">
                                                <a class="menu-link ps-0 py-2"
                                                    href="../dist/documentation/base/utilities.html">Components</a>
                                            </li>
                                            <li class="menu-item">
                                                <a class="menu-link ps-0 py-2"
                                                    href="../dist/documentation/getting-started.html">Documentation</a>
                                            </li>
                                            <li class="menu-item">
                                                <a class="menu-link ps-0 py-2"
                                                    href="https://preview.keenthemes.com/start/layout-builder.html">Layout
                                                    Builder</a>
                                            </li>
                                            <li class="menu-item">
                                                <a class="menu-link ps-0 py-2"
                                                    href="../dist/documentation/getting-started/changelog.html">Changelog
                                                    <span
                                                        class="badge badge-changelog badge-light-danger bg-hover-danger text-hover-white fw-bold fs-9 px-2 ms-2">v1.0.9</span></a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
    ...
    <!--end::Scrolltop-->
    <!--end::Main-->
    <script>var hostUrl = "{{route("home")}}/public/";</script>
    <!--begin::Javascript-->

            ...
            <div
                ...
                <div class="d-flex flex-column-fluid flex-center py-10">
                    ...
                    <form class="form w-100" novalidate="novalidate" id="kt_login_signin_form"
                        data-after-login-url="../dist/index.html">
                        <!--begin::Title-->
                        ...
                        <div class="pb-lg-0 pb-5">
                            <button type="submit" id="kt_login_signin_form_submit_button"
                                class="btn btn-primary fw-bolder fs-6 px-8 py-4 my-3 me-3">Sign In</button>
                    ...
                    <form class="form d-none w-100" novalidate="novalidate" id="kt_login_signup_form">
                        ...
                        <div class="fv-row mb-10">
                            ...
                            <input class="form-control form-control-lg form-control-solid" type="password"
                                placeholder="" name="cpassword" autocomplete="off" />
                        </div>
                        <!--end::Form group-->
                        <!--begin::Form group-->
                        <div class="fv-row mb-10">
                            <div class="form-check form-check-inline form-check-custom form-check-solid mb-5">
                                <input class="form-check-input" type="checkbox" name="agree"
                                    id="kt_login_toc_agree" value="1" />
                                <label class="form-check-label fw-bold text-gray-600" for="kt_login_toc_agree">I Agree
                                    the
                ...
                <!--begin::Footer-->
                <div
                    class="d-flex justify-content-lg-start justify-content-center align-items-center py-2 py-lg-7 py-lg-0 fs-5 fw-bolder">
                    <a href="https://keenthemes.com" target="_blank"
                        class="text-gray-600 text-hover-primary">About</a>
                    <a href="https://keenthemes.com/support" target="_blank"
                        class="text-gray-600 text-hover-primary ms-10">Support</a>
                    <a href="https://themes.getbootstrap.com/product/start-multipurpose-admin-dashboard-theme/"
                        target="_blank" class="text-gray-600 text-hover-primary ms-10">Purchase</a>
                </div>
                <!--end::Footer-->
            </div>
            <!--end::Content-->
